...
package app.whisperme.keyboard.app.ext
...
import app.whisperme.keyboard.app.settings.advanced.RadioListItem
import app.whisperme.keyboard.app.settings.theme.DialogProperty
import app.whisperme.keyboard.app.settings.theme.PrettyPrintConfig
import app.whisperme.keyboard.app.settings.theme.ThemeEditorScreen
import app.whisperme.keyboard.cacheManager
import app.whisperme.keyboard.extensionManager
import app.whisperme.keyboard.ime.keyboard.KeyboardExtension
import app.whisperme.keyboard.ime.theme.ThemeExtension
import app.whisperme.keyboard.ime.theme.ThemeExtensionComponent
import app.whisperme.keyboard.ime.theme.ThemeExtensionComponentEditor
import app.whisperme.keyboard.ime.theme.ThemeExtensionComponentImpl
import app.whisperme.keyboard.ime.theme.ThemeExtensionEditor
import app.whisperme.keyboard.lib.ValidationResult
import app.whisperme.keyboard.lib.cache.CacheManager
import app.whisperme.keyboard.lib.compose.FlorisButtonBar
import app.whisperme.keyboard.lib.compose.FlorisIconButton
import app.whisperme.keyboard.lib.compose.FlorisInfoCard
import app.whisperme.keyboard.lib.compose.FlorisOutlinedBox
import app.whisperme.keyboard.lib.compose.FlorisScreen
import app.whisperme.keyboard.lib.compose.FlorisUnsavedChangesDialog
import app.whisperme.keyboard.lib.compose.Validation
import app.whisperme.keyboard.lib.compose.defaultFlorisOutlinedBox
import app.whisperme.keyboard.lib.compose.stringRes
import app.whisperme.keyboard.lib.ext.Extension
import app.whisperme.keyboard.lib.ext.ExtensionComponent
import app.whisperme.keyboard.lib.ext.ExtensionComponentName
import app.whisperme.keyboard.lib.ext.ExtensionDefaults
import app.whisperme.keyboard.lib.ext.ExtensionEditor
import app.whisperme.keyboard.lib.ext.ExtensionJsonConfig
import app.whisperme.keyboard.lib.ext.ExtensionMaintainer
import app.whisperme.keyboard.lib.ext.ExtensionManager
import app.whisperme.keyboard.lib.ext.ExtensionMeta
import app.whisperme.keyboard.lib.ext.ExtensionValidation
import app.whisperme.keyboard.lib.ext.validate
import app.whisperme.keyboard.lib.io.FlorisRef
import app.whisperme.keyboard.lib.io.ZipUtils
import app.whisperme.keyboard.lib.rememberValidationResult
import app.whisperme.keyboard.themeManager
                        ...
                        CreateFrom.EXISTING -> {
                            ...
                            if (componentName.extensionId == extId) {
                                ...
                                if (componentEditor.stylesheetEditor != null) {
                                    ...
                                    stylesheetFile.parentFile?.mkdirs()
                                    val stylesheet = componentEditor.stylesheetEditor!!.build().toJson(
                                        PrettyPrintConfig
                                    ).getOrThrow()
                                    stylesheetFile.writeText(stylesheet)
