...
package app.whisperme.keyboard.app.setup
...
import app.whisperme.keyboard.app.AppPrefs
...
import app.whisperme.keyboard.lib.compose.FlorisScreenScope
import app.whisperme.keyboard.lib.compose.FlorisStep
import app.whisperme.keyboard.lib.compose.FlorisStepLayout
import app.whisperme.keyboard.lib.compose.FlorisStepState
...
import app.whisperme.keyboard.lib.util.launchUrl
...
private fun FlorisScreenScope.content(
    ...
    content {
        ...
        LaunchedEffect(Unit) {
            while (true) {
                delay(200L)
                val isEnabled = app.whisperme.keyboard.lib.util.InputMethodUtils.isFlorisboardEnabled(context)
                if (stepState.getCurrentAuto().value == Steps.EnableIme.id &&
                    ...
                    context.launchActivity(app.whisperme.keyboard.app.FlorisAppActivity::class) {
