...
import app.whisperme.keyboard.app.settings.theme.DisplayKbdAfterDialogs
import app.whisperme.keyboard.app.settings.theme.SnyggLevel
import app.whisperme.keyboard.app.setup.NotificationPermissionState
import app.whisperme.keyboard.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import app.whisperme.keyboard.ime.core.DisplayLanguageNamesIn
import app.whisperme.keyboard.ime.core.Subtype
import app.whisperme.keyboard.ime.input.CapitalizationBehavior
import app.whisperme.keyboard.ime.input.HapticVibrationMode
import app.whisperme.keyboard.ime.input.InputFeedbackActivationMode
import app.whisperme.keyboard.ime.keyboard.IncognitoMode
import app.whisperme.keyboard.ime.keyboard.SpaceBarMode
import app.whisperme.keyboard.ime.landscapeinput.LandscapeInputUiMode
import app.whisperme.keyboard.ime.media.emoji.Emoji
import app.whisperme.keyboard.ime.media.emoji.EmojiHairStyle
import app.whisperme.keyboard.ime.media.emoji.EmojiHistory
import app.whisperme.keyboard.ime.media.emoji.EmojiSkinTone
import app.whisperme.keyboard.ime.media.emoji.EmojiSuggestionType
import app.whisperme.keyboard.ime.nlp.SpellingLanguageMode
import app.whisperme.keyboard.ime.onehanded.OneHandedMode
import app.whisperme.keyboard.ime.smartbar.CandidatesDisplayMode
import app.whisperme.keyboard.ime.smartbar.ExtendedActionsPlacement
import app.whisperme.keyboard.ime.smartbar.IncognitoDisplayMode
import app.whisperme.keyboard.ime.smartbar.SmartbarLayout
import app.whisperme.keyboard.ime.smartbar.quickaction.QuickAction
import app.whisperme.keyboard.ime.smartbar.quickaction.QuickActionArrangement
import app.whisperme.keyboard.ime.smartbar.quickaction.QuickActionJsonConfig
import app.whisperme.keyboard.ime.text.gestures.SwipeAction
import app.whisperme.keyboard.ime.text.key.KeyCode
import app.whisperme.keyboard.ime.text.key.KeyHintConfiguration
import app.whisperme.keyboard.ime.text.key.KeyHintMode
import app.whisperme.keyboard.ime.text.key.UtilityKeyAction
import app.whisperme.keyboard.ime.text.keyboard.TextKeyData
import app.whisperme.keyboard.ime.theme.ThemeMode
import app.whisperme.keyboard.ime.theme.extCoreTheme
import app.whisperme.keyboard.lib.compose.ColorPreferenceSerializer
import app.whisperme.keyboard.lib.ext.ExtensionComponentName
import app.whisperme.keyboard.lib.observeAsTransformingState
import app.whisperme.keyboard.lib.util.VersionName
            ...
            "smartbar__action_arrangement" -> {
                ...
                if (QuickAction.InsertKey(TextKeyData.LANGUAGE_SWITCH) !in newArrangement) {
                    newArrangement = newArrangement.copy(
                        dynamicActions = newArrangement.dynamicActions.plus(
