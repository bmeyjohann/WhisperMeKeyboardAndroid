...
package app.whisperme.keyboard.lib.ext
...
import app.whisperme.keyboard.ime.nlp.LanguagePackExtension
import app.whisperme.keyboard.ime.text.composing.Appender
import app.whisperme.keyboard.ime.text.composing.Composer
import app.whisperme.keyboard.ime.text.composing.HangulUnicode
import app.whisperme.keyboard.ime.text.composing.KanaUnicode
import app.whisperme.keyboard.ime.text.composing.WithRules
...
import app.whisperme.keyboard.lib.io.delete
import app.whisperme.keyboard.lib.io.listDirs
import app.whisperme.keyboard.lib.io.listFiles
import app.whisperme.keyboard.lib.io.loadJsonAsset
            ...
            internalModuleRef.listFiles(appContext).fold(
                onSuccess = { extRefs ->
                    for (extRef in extRefs) {
                        ...
                        ZipUtils.readFileFromArchive(appContext, extRef,
                            ExtensionDefaults.MANIFEST_FILE_NAME
                        ).fold(
                            onSuccess = { metaStr ->
